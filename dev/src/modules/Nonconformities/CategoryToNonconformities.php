...
if(isset($forfield) && $forfield != '' && $focus->popup_type != 'detailview') {
	...
	$value = "<a href='javascript:window.close();' onclick='return {$autocomplete_return_function[$entity_id]}closePopup()'>$value1</a>"; //crmv@21048m
}
