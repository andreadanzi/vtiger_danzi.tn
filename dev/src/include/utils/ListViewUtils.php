			...
			foreach ($focus->search_fields as $name => $tableinfo) {
				...
				if ($is_admin == true || $profileGlobalPermission[1] == 0 || $profileGlobalPermission[2] == 0 || in_array($fieldname, $field) || $module == 'Users') {
					if ($fieldname == '') {
						...
						// danzi.tn@20130812
						elseif (isset($focus->popup_fields) && in_array($fieldname, $focus->popup_fields) && $_REQUEST['srcmodule'] == 'Relations' && $_REQUEST['forfield']=='link_from') {
                    		include("modules/Relations/CategoryFromRelations.php");
                    	}
